...
@NamedQueries({
	...
	@NamedQuery(name = Turma.OBTER_PARA_SELECAO_TURMA, query = Turma.OBTER_PARA_SELECAO_TURMA_QUERY)
})
public class Turma implements BaseEntity<Integer> {
	...
	public static final String OBTER_PARA_SELECAO_TURMA = "Turma.obterParaSelecaoTurma";
	static final String OBTER_PARA_SELECAO_TURMA_QUERY = "SELECT distinct T FROM Turma T " +
															" LEFT JOIN FETCH T.alunosTurma T_AT " + 
															" LEFT JOIN FETCH T_AT.aluno T_AT_A" +
															" LEFT JOIN FETCH T_AT_A.alunosTurma T_AT_A_AT" +
															" LEFT JOIN FETCH T_AT_A.chamadasAluno T_AT_A_CA" +
